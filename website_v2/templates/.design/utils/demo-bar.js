...
function initDemoBar({ title = 'Template Preview', backHref = '../', orderHref = '../../contact/index.html' } = {}) {
  ...
  bar.innerHTML = `
    ...
    <div class="demo-right">
      <a href="${backHref}" class="demo-btn demo-back"><i class="fa fa-arrow-left"></i> Back to Template</a>
      <a href="${orderHref}" class="demo-btn demo-order"><i class="fa fa-rocket"></i> Order This</a>
    </div>
  `;
